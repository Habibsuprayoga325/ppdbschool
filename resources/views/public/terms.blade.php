...
@section('title', 'Syarat dan Ketentuan | PPDB Online SDN Mekar Mukti 06')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="compliance-card">
                    ...
                    <p class="compliance-text">Selamat datang di portal Penerimaan Peserta Didik Baru (PPDB) Online SDN Mekar Mukti 06. Syarat & ketentuan berikut mengatur penggunaan situs web kami dan layanan pembayaran administrasi sekolah terintegrasi kami. Dengan mengakses situs ini dan mendaftar, Anda menyetujui seluruh ketentuan di bawah ini.</p>

                    <h3 class="compliance-section-title">1. Ketentuan Umum</h3>
                    <p class="compliance-text">Situs ini disediakan untuk memfasilitasi pendaftaran siswa baru secara daring dan pembayaran administrasi penunjang pendidikan di SDN Mekar Mukti 06. Pihak sekolah berhak untuk menolak pendaftaran apabila data yang diserahkan terbukti tidak valid atau palsu.</p>
                    ...
                    <ul class="compliance-list">
                        ...
                        <li>Pembayaran administrasi sekolah (meliputi Seragam, Buku, MOS, Iuran Komite, dan Atribut) dilakukan melalui layanan Midtrans sebagai mitra payment gateway resmi kami.</li>
                        <li>Transaksi pembayaran diproses langsung secara terintegrasi pada situs web kami menggunakan sistem pop-up Midtrans Snap yang aman tanpa dialihkan ke situs web eksternal lainnya.</li>
                    ...
                    <p class="compliance-text">SDN Mekar Mukti 06 dapat mengubah syarat dan ketentuan ini sewaktu-waktu tanpa pemberitahuan terlebih dahulu. Perubahan akan berlaku segera setelah dipublikasikan pada halaman ini. Harap meninjau halaman ini secara berkala.</p>
                    ...
                    <ul class="compliance-list">
                        <li><strong>Telepon:</strong> 021-89840828</li>
                        <li><strong>Email:</strong> ppdb@sdnmekarmukti06.sch.id</li>
                        <li><strong>Website Resmi:</strong> www.sdnmekarmukti06.sch.id</li>
                        <li><strong>Alamat:</strong> Jalan Kasuari XV, Perum Cikarang Baru, Bekasi, Jawa Barat.</li>
                    </ul>
                </div>
            </div>
        </div>
