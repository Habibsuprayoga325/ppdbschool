...
@section('title', 'Kebijakan Pengembalian Dana | PPDB Online SDN Mekar Mukti 06')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="compliance-card">
                    ...
                    <p class="compliance-text">Sebagai lembaga pendidikan dasar negeri, seluruh transaksi pembayaran yang diproses melalui portal PPDB Online SDN Mekar Mukti 06 dialokasikan untuk pemenuhan kebutuhan atribut siswa baru (seperti seragam, buku wajib, kartu pelajar, dll) serta kegiatan penunjang akademik awal tahun ajaran.</p>
                    ...
                    <ul class="compliance-list">
                        ...
                        <li>Untuk klaim transaksi ganda, silakan hubungi panitia melalui email ppdb@sdnmekarmukti06.sch.id dengan menyertakan bukti pembayaran dan kode transaksi Midtrans (order ID) yang sah. Klaim wajib diajukan maksimal 7 hari kerja sejak tanggal transaksi.</li>
                    ...
                    <ul class="compliance-list">
                        ...
                        <li>SDN Mekar Mukti 06 tidak membebankan biaya tambahan untuk penukaran atribut/seragam yang cacat atau salah ukuran, selama persediaan stok di koperasi sekolah masih tersedia.</li>
                    </ul>
                    ...
                    <ul class="compliance-list">
                        <li><strong>Telepon Koperasi & PPDB:</strong> 021-89840828</li>
                        <li><strong>Email Layanan:</strong> ppdb@sdnmekarmukti06.sch.id</li>
                        <li><strong>Alamat Penukaran:</strong> Koperasi SDN Mekar Mukti 06, Jalan Kasuari XV, Perum Cikarang Baru, Bekasi, Jawa Barat.</li>
                    </ul>
                </div>
            </div>
        </div>
